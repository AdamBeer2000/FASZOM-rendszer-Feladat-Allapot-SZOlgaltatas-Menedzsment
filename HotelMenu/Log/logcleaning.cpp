...
//CONSTRUCTORS
Logs::LogCleaning::LogCleaning(date date_of_cleaning):cleaning_date(date_of_cleaning) {}

Logs::LogCleaning::LogCleaning(std::string item_c, date date_of_cleaning):lost_item(item_c), cleaning_date(date_of_cleaning)
{
